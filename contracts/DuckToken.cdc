...
/// DuckToken is a credit token on computational resources in the Duckee.
/// User buys DuckToken in a fixed price ($0.01) ands pay for generating an art.
pub contract DuckToken: FungibleToken {

    /// Total supply of DuckTokens in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @DuckToken.Vault
        ...
        destroy() {
            if self.balance > 0.0 {
                DuckToken.totalSupply = DuckToken.totalSupply - self.balance
            }
        }

        /// The way of getting all the Metadata Views implemented by DuckToken
        ///
        ...
        /// The way of getting a Metadata View out of the DuckToken
        ///
            ...
            switch view {
                ...
                case Type<FungibleTokenMetadataViews.FTDisplay>():
                    ...
                    return FungibleTokenMetadataViews.FTDisplay(
                        name: "Duckee Token",
                        symbol: "DUCK",
                        description: "DuckToken is a credit token on computational resources in the duckee.xyz.",
                        externalURL: MetadataViews.ExternalURL("https://duckee.xyz/"),
                        logos: medias,
                        socials: {
                            "twitter": MetadataViews.ExternalURL("https://twitter.com/duckee-xyz")
                        }
                    )
                case Type<FungibleTokenMetadataViews.FTVaultData>():
                    return FungibleTokenMetadataViews.FTVaultData(
                        ...
                        createEmptyVaultFunction: (fun (): @DuckToken.Vault {
                            return <-DuckToken.createEmptyVault()
                        })
                    )
            }
            return nil
    ...
    pub resource Minter {
        ...
        ///
        pub fun mintTokens(amount: UFix64): @DuckToken.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            DuckToken.totalSupply = DuckToken.totalSupply + amount
    ...
    init() {
        ...
        self.VaultStoragePath = /storage/DuckTokenVault
        ...
        self.account.link<&DuckToken.Vault{FungibleToken.Balance}>(
